import SlidingTabLayout.TabColorizer
...
import informatica.sp.senai.br.tablayout.helper.SlidingTabStrip
...
class SlidingTabLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : HorizontalScrollView(context, attrs, defStyle) {
    ...
    private val mContentDeions = SparseArray<String>()
    ...
    private fun populateTabStrip() {
        ...
        for (i in 0 until adapter!!.count) {
            ...
            val desc = mContentDeions.get(i, null)
            if (desc != null) {
    ...
    fun setContentDeion(i: Int, desc: String) {
        mContentDeions.put(i, desc)
    }
